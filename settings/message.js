...
var mensagens = ["Por favor, aguarde um momento...","Salve cria, só aguarde um pouquinho que já estou enviando!!","Aquieta o coração, já estou enviando!","Espere sentado que estou enviando!","Pisa no freio aí, tô enfiando já\n\nOps... Enviando* rsrs!","Foi daqui que pediram comando? Ta chegando...","Oq você não pede chorando, que eu não faço sorrindo? Enviando já!","Em 365 dias úteis, termino o comando\n\nKkkk meme, to enviando!","Não precisa gritar, já ouvi e tô enviando o seu pedido!","Aproveita que tô terminando aqui e beba água, hidrate-se!","Seu pedido é uma ordem, terminando!","Manda quem pode, obedece quem tem juízo. Já tô enviando...","Jaja está na mão, aguarde um instante!","Quem espera, sempre alcança","Tô enviando já!","Tô com preguiça, mas calma aí!"]
...
msg: {
  ...
  premium: 'Este comando é exclusivo para usuários vips.',
  mod: 'Este comando é específico para o meu dono.',
  banido: 'Você foi banido de utilizar os meus comandos.' ,
  donosmt: 'Apenas o dono do bot pode utilizar este comando.',
  donosmt2: 'Apenas o dono do bot pode utilizar este comando.',
  ...
  privado: 'Este comando só pode ser utilizado no pv.',                     
  modobn: `Solicite ao admin para ativar o modo gamer para usar este comando.\n\nExemplo: modo-gamer 1\nEscreva exatamente assim, incluindo o traço para funcionar.`
}
