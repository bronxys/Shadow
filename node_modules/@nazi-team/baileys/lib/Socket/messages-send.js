...
const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            else if (((0, WABinary_1.isJidGroup)(jid) || (0, WABinary_1.isJidUser)(jid) && ['viewOnceMessage', 'viewOnceMessageV2', 'viewOnceMessageV2Extension', 'ephemeralMessage', 'templateMessage', 'interactiveMessage', 'buttonsMessage'].find(_ => message === null || message === void 0 ? void 0 : message[_]))) {
                stanza.content.push({
                    tag: "biz",
                    attrs: {},
                    content: [
